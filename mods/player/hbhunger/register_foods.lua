...
if core.get_modpath("moretrees") ~= nil then
...
if core.get_modpath("dwarves") ~= nil then
...
if core.get_modpath("fishing") ~= nil then
...
if core.get_modpath("glooptest") ~= nil then
	hbhunger.register_food("glooptest:kalite_lump", 1)
end

if core.get_modpath("bushes") ~= nil then
...
if core.get_modpath("mushroom") ~= nil then
...
if core.get_modpath("docfarming") ~= nil then
...
if core.get_modpath("farming_plus") ~= nil then
...
if core.get_modpath("mtfoods") ~= nil then
...
if core.get_modpath("fruit") ~= nil then
...
if core.get_modpath("mush45") ~= nil then
	hbhunger.register_food("mush45:meal", 4)
end

if core.get_modpath("seaplants") ~= nil then
...
if core.get_modpath("mobfcooking") ~= nil then
...
if core.get_modpath("creatures") ~= nil then
...
if core.get_modpath("farming") and farming.mod == "redo" then
...
if core.get_modpath("kpgmobs") ~= nil then
...
if core.get_modpath("jkfarming") ~= nil then
...
if core.get_modpath("ferns") ~= nil then
...
if core.get_modpath("pizza") ~= nil then
