...
local function get_setting(name, default)
    ...
    value = value or ""
    core.log("verbose", "Mapgen Config: Setting '"..name.."' = "..value)
    return value
end
...
core.register_alias("yellow_crystals:mese_crystal_ore1", "mese_crystals:mese_crystal_ore1")
core.register_alias("yellow_crystals:mese_crystal_ore2", "mese_crystals:mese_crystal_ore2")
core.register_alias("yellow_crystals:mese_crystal_ore3", "mese_crystals:mese_crystal_ore3")
core.register_alias("yellow_crystals:mese_crystal_ore4", "mese_crystals:mese_crystal_ore4")
core.register_alias("yellow_crystals:crystaline_bell", "mese_crystals:crystaline_bell")
core.register_alias("yellow_crystals:mese_crystal_seed", "mese_crystals:mese_crystal_seed")

core.register_node("yellow_crystals:mese_crystal_ore1", {
...
core.register_node("yellow_crystals:mese_crystal_ore2", {
	description = S("Mese Crystal Ore"),
...
core.register_node("yellow_crystals:mese_crystal_ore3", {
	description = S("Mese Crystal Ore"),
...
core.register_node("yellow_crystals:mese_crystal_ore4", {
	description = S("Mese Crystal Ore"),
...
core.register_tool("yellow_crystals:crystaline_bell", {
...
core.register_craftitem("yellow_crystals:mese_crystal_seed", {
...
core.register_ore({
	...
	clust_scarcity = tonumber(get_setting("yellow_crystals.ore1_scarcity", 18 * 18 * 18)),
	clust_num_ores = 1,
	clust_size     = 1,
	y_max          = tonumber(get_setting("yellow_crystals.ore1_ymax", -150)),
	y_min          = tonumber(get_setting("yellow_crystals.ore1_ymin", 500)),
})
...
core.register_ore({
	...
	wherein        = "default:stone",
	clust_scarcity = tonumber(get_setting("yellow_crystals.ore2_scarcity", 20 * 20 * 20)),
	clust_num_ores = 1,
	clust_size     = 1,
	y_max          = tonumber(get_setting("yellow_crystals.ore2_ymax", -250)),
	y_min          = tonumber(get_setting("yellow_crystals.ore2_ymin", -31000)),
})
...
core.register_ore({
	...
	wherein        = "default:stone",
	clust_scarcity = tonumber(get_setting("yellow_crystals.ore3_scarcity", 20 * 20 * 20)),
	clust_num_ores = 1,
	clust_size     = 1,
	y_max          = tonumber(get_setting("yellow_crystals.ore3_ymax", -350)),
	y_min          = tonumber(get_setting("yellow_crystals.ore3_ymin", -31000)),
})
...
core.register_ore({
	...
	wherein        = "default:stone",
	clust_scarcity = tonumber(get_setting("yellow_crystals.ore4_scarcity", 20 * 20 * 20)),
	clust_num_ores = 1,
	clust_size     = 1,
	y_max          = tonumber(get_setting("yellow_crystals.ore4_ymax", -450)),
	y_min          = tonumber(get_setting("yellow_crystals.ore4_ymin", -31000)),
})
